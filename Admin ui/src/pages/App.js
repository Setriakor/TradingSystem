...
import CancelTable from "./Table/CancelTables";
import AllTable from "./Table/AllTables";
import ActiveTable from "./Table/ActiveTables";
import NewTable from "./Table/NewTables";
import ClientTable from "./Table/ClientTables";
      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classNames(classes.container, !navDrawerOpen && classes.containerFull)}>
          <Switch>
            ...
            <Route path="/table/totalclient" component={ClientTable}/>
            <Route path="/table/cancel" component={CancelTable} />
            <Route path="/table/all" component={AllTable} />
            <Route path="/table/active" component={ActiveTable} />
