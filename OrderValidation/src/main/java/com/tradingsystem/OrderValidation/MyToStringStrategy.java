...
public class MyToStringStrategy implements  ToStringStrategy {
     ...
     */
    private boolean useIdentityHashCode = false;
     ...
     */
    protected void appendFieldStart(ObjectLocator parentLocator, Object parent, String fieldName,
     ...
     * @param propertyName the field name, typically not used as already appended
     */
    ...
    public StringBuilder appendField(ObjectLocator parentLocator, Object parent, String fieldName, StringBuilder buffer,
            Object value) {
    ...
    @SuppressWarnings("unchecked")
    public StringBuilder append(ObjectLocator parentLocator, Object parent, String fieldName, StringBuilder buffer,
            Collection value) {
        appendFieldStart(parentLocator, parent, fieldName, buffer);
        append(property(parentLocator, fieldName, value), buffer, value);
        appendFieldEnd(parentLocator, parent, fieldName, buffer);
    ...
    public static final MyToStringStrategy INSTANCE = new MyToStringStrategy();
}
